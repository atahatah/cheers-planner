...
String _$requireUserHash() => r'22902441daf2fce090c5d40aba726701645f3c24';

/// See also [requireUser].
@ProviderFor(requireUser)
final requireUserProvider = AutoDisposeProvider<User>.internal(
  requireUser,
...
@Deprecated('Will be removed in 3.0. Use Ref instead')
// ignore: unused_element
typedef RequireUserRef = AutoDisposeProviderRef<User>;
