...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,aiRecArea,aiRecDate,aiRecStore,purpose,const DeepCollectionEquality().hash(candidateDateTimes),allergiesEtc,const DeepCollectionEquality().hash(organizerId),const DeepCollectionEquality().hash(participantId),budgetUpperLimit,const DeepCollectionEquality().hash(fixedQuestion),minutes);

@override
String toString() {
  return 'EventEntry(id: $id, aiRecArea: $aiRecArea, aiRecDate: $aiRecDate, aiRecStore: $aiRecStore, purpose: $purpose, candidateDateTimes: $candidateDateTimes, allergiesEtc: $allergiesEtc, organizerId: $organizerId, participantId: $participantId, budgetUpperLimit: $budgetUpperLimit, fixedQuestion: $fixedQuestion, minutes: $minutes)';
}
