...
mixin _$EventEntry {
 ...
 String? get id; Map<String, dynamic>? get aiResults; String get purpose;@ListToMapConverter<CandidateDateTime>(prefix: 'datetime') List<CandidateDateTime> get candidateDateTimes; String? get allergiesEtc; List<String> get organizerId; List<String> get participantId; int get budgetUpperLimit; List<String> get fixedQuestion; int get minutes;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is EventEntry&&(identical(other.id, id) || other.id == id)&&const DeepCollectionEquality().equals(other.aiResults, aiResults)&&(identical(other.purpose, purpose) || other.purpose == purpose)&&const DeepCollectionEquality().equals(other.candidateDateTimes, candidateDateTimes)&&(identical(other.allergiesEtc, allergiesEtc) || other.allergiesEtc == allergiesEtc)&&const DeepCollectionEquality().equals(other.organizerId, organizerId)&&const DeepCollectionEquality().equals(other.participantId, participantId)&&(identical(other.budgetUpperLimit, budgetUpperLimit) || other.budgetUpperLimit == budgetUpperLimit)&&const DeepCollectionEquality().equals(other.fixedQuestion, fixedQuestion)&&(identical(other.minutes, minutes) || other.minutes == minutes));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,const DeepCollectionEquality().hash(aiResults),purpose,const DeepCollectionEquality().hash(candidateDateTimes),allergiesEtc,const DeepCollectionEquality().hash(organizerId),const DeepCollectionEquality().hash(participantId),budgetUpperLimit,const DeepCollectionEquality().hash(fixedQuestion),minutes);

@override
String toString() {
  return 'EventEntry(id: $id, aiResults: $aiResults, purpose: $purpose, candidateDateTimes: $candidateDateTimes, allergiesEtc: $allergiesEtc, organizerId: $organizerId, participantId: $participantId, budgetUpperLimit: $budgetUpperLimit, fixedQuestion: $fixedQuestion, minutes: $minutes)';
}
...
@useResult
$Res call({
 String? id, Map<String, dynamic>? aiResults, String purpose,@ListToMapConverter<CandidateDateTime>(prefix: 'datetime') List<CandidateDateTime> candidateDateTimes, String? allergiesEtc, List<String> organizerId, List<String> participantId, int budgetUpperLimit, List<String> fixedQuestion, int minutes
});
...
/// Create a copy of EventEntry
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? aiResults = freezed,Object? purpose = null,Object? candidateDateTimes = null,Object? allergiesEtc = freezed,Object? organizerId = null,Object? participantId = null,Object? budgetUpperLimit = null,Object? fixedQuestion = null,Object? minutes = null,}) {
  return _then(_self.copyWith(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String?,aiResults: freezed == aiResults ? _self.aiResults : aiResults // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,purpose: null == purpose ? _self.purpose : purpose // ignore: cast_nullable_to_non_nullable
...
class _EventEntry implements EventEntry {
  const _EventEntry({this.id, final  Map<String, dynamic>? aiResults, required this.purpose, @ListToMapConverter<CandidateDateTime>(prefix: 'datetime') required final  List<CandidateDateTime> candidateDateTimes, required this.allergiesEtc, required final  List<String> organizerId, final  List<String> participantId = const [], required this.budgetUpperLimit, required final  List<String> fixedQuestion, required this.minutes}): _aiResults = aiResults,_candidateDateTimes = candidateDateTimes,_organizerId = organizerId,_participantId = participantId,_fixedQuestion = fixedQuestion;
  factory _EventEntry.fromJson(Map<String, dynamic> json) => _$EventEntryFromJson(json);

@override final  String? id;
 final  Map<String, dynamic>? _aiResults;
@override Map<String, dynamic>? get aiResults {
  final value = _aiResults;
...
@override@JsonKey() List<String> get participantId {
...
/// Create a copy of EventEntry
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? aiResults = freezed,Object? purpose = null,Object? candidateDateTimes = null,Object? allergiesEtc = freezed,Object? organizerId = null,Object? participantId = null,Object? budgetUpperLimit = null,Object? fixedQuestion = null,Object? minutes = null,}) {
  return _then(_EventEntry(
id: freezed == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String?,aiResults: freezed == aiResults ? _self._aiResults : aiResults // ignore: cast_nullable_to_non_nullable
as Map<String, dynamic>?,purpose: null == purpose ? _self.purpose : purpose // ignore: cast_nullable_to_non_nullable
